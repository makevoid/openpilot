...
- ZSS for Prius 2019 (changes taken from @ErichMoraga's branch)
- Decreased acceleration for chiller city driving
- Allow to set minimum speed to 20mph (for city driving)
- Automatic resume after a stop (taken from ErichM, I may disable this)
- Increased base steer torque for sharper turns (currently off: will turn that on when I will be able to have some free time to do some testing)

---

* ZSS - Zorro's Steer Sensor
